    ...
    void mine_pattern(char *p) {
        ...
        %%{
            ...
            main := ((('a'([0-9]+ $from(NUM))'b') | ('a'([0-9]+ $from(NUM))'c') | ('a'([0-9]+ $from(NUM))'d') | ('b'([0-9]+ $from(NUM))'a') | ('b'([0-9]+ $from(NUM))'c') | ('b'([0-9]+ $from(NUM))'d') | ('c'([0-9]+ $from(NUM))'a') | ('c'([0-9]+ $from(NUM))'b') | ('c'([0-9]+ $from(NUM))'d') | ('d'([0-9]+ $from(NUM))'a') | ('d'([0-9]+ $from(NUM))'b') | ('d'([0-9]+ $from(NUM))'c'))+) $to(CHUNK) %to(A) $lerr(E);
